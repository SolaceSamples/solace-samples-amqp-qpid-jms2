...
/**
 *  Solace AMQP JMS 2.0 Samples: MessageProducer
 */
...
/**
 * AMQP Container that produces messages using JMS 2.0 API. Solace Message Router is used as the message broker.
 * 
